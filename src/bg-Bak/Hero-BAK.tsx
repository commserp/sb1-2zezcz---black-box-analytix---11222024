...
export function Hero() {
  ...
  const taglines = ['Ready for Anything', 'Prepared for Everything'];
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-12 px-4 max-w-4xl mx-auto">
        ...
        <p
          className={`text-lg md:text-xl text-white/80 max-w-2xl mx-auto transform transition-all duration-1000 delay-1000 ${
            isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}
        >
          Empowering organizations with cutting-edge analytics and predictive
          intelligence for a world of evolving challenges and opportunities.
        </p>

        <div
          className={`flex flex-col sm:flex-row justify-center gap-4 transform transition-all duration-1000 delay-1500 ${
            isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}
        >
          <Button
